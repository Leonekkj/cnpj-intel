...
_DEPARTAMENTOS_TEXTO = [
    ...
    ("domiciliar",     ("Assistência Social",                 "Saúde e Bem-estar")),
    # Varejo de Saúde e Farmácias — antes de padrões genéricos
    ...
    ("bares",          ("Bares e Bebidas",                    "Alimentação e Hospitalidade")),
    ("bebidas",        ("Bares e Bebidas",                    "Alimentação e Hospitalidade")),
    ("buffet",         ("Delivery e Catering",                "Alimentação e Hospitalidade")),
    ("catering",       ("Delivery e Catering",                "Alimentação e Hospitalidade")),
    ("ambulante",      ("Delivery e Catering",                "Alimentação e Hospitalidade")),
    ("fornec",         ("Delivery e Catering",                "Alimentação e Hospitalidade")),
    ...
    ("promoc",         ("Marketing e Publicidade",            "Tecnologia e Marketing")),
    ...
    ("ensino",         ("Cursos Livres e Idiomas",            "Educação e Treinamento")),
    ...
    ("alvenar",        ("Construção Civil e Edifícios",       "Construção e Infraestrutura")),
    ...
    ("pintura",        ("Serviços Especializados de Construção","Construção e Infraestrutura")),
    # Imobiliário
    ("condomin",       ("Administração de Condomínios",       "Imobiliário")),
    ("imobiliar",      ("Locação e Gestão de Imóveis",        "Imobiliário")),
    ("imov",           ("Locação e Gestão de Imóveis",        "Imobiliário")),
    ("locac",          ("Locação e Gestão de Imóveis",        "Imobiliário")),
    ("corretag",       ("Corretagem Imobiliária",             "Imobiliário")),
    # Financeiro
    ...
    ("cobranc",        ("Bancos e Crédito",                   "Financeiro")),
    # Logística e Transporte — específicos antes de "veiculo" genérico
    ("taxi",           ("Transporte de Passageiros",          "Logística e Transporte")),
    ...
    ("document",       ("Serviços Administrativos",           "Serviços Profissionais")),
    ("recrutam",       ("Recursos Humanos",                   "Serviços Profissionais")),
    ("selecao",        ("Recursos Humanos",                   "Serviços Profissionais")),
    # Serviços Locais — "veiculo" antes de "pintura" para não conflitar
    ("lanternag",      ("Serviços Automotivos",               "Serviços Locais")),
    ("funilaria",      ("Serviços Automotivos",               "Serviços Locais")),
    ("veiculo",        ("Serviços Automotivos",               "Serviços Locais")),
    ("cabeleir",       ("Beleza e Estética",                  "Serviços Locais")),
    ("manicure",       ("Beleza e Estética",                  "Serviços Locais")),
    ...
    ("condicion",      ("Academias e Esportes",               "Serviços Locais")),
    ...
    ("viag",           ("Agências de Viagem e Turismo",       "Serviços Locais")),
    ("turism",         ("Agências de Viagem e Turismo",       "Serviços Locais")),
    ("agencia de viag",("Agências de Viagem e Turismo",       "Serviços Locais")),
    ("manutenc",       ("Reparação e Manutenção",             "Serviços Locais")),
    ("reparo",         ("Reparação e Manutenção",             "Serviços Locais")),
    ("domestic",       ("Serviços Domésticos",                "Serviços Locais")),
    ("music",          ("Arte e Entretenimento",              "Serviços Locais")),
    ("feira",          ("Eventos e Congressos",               "Serviços Locais")),
    ("congresso",      ("Eventos e Congressos",               "Serviços Locais")),
    ("exposicao",      ("Eventos e Congressos",               "Serviços Locais")),
    # Agro e Agronegócio
    ("bovin",          ("Pecuária",                          "Agro e Agronegócio")),
    ("suino",          ("Pecuária",                          "Agro e Agronegócio")),
    ("avicul",         ("Pecuária",                          "Agro e Agronegócio")),
    ("agricol",        ("Agricultura e Cultivos",             "Agro e Agronegócio")),
    ("cultiv",         ("Agricultura e Cultivos",             "Agro e Agronegócio")),
    ...
    ("religio",        ("Organizações Religiosas",            "Setor Público e Associações")),
    ("politic",        ("Administração Pública",              "Setor Público e Associações")),
    ("admin publ",     ("Administração Pública",              "Setor Público e Associações")),
    ...
    ("ong",            ("ONGs e Fundações",                   "Setor Público e Associações")),
    ("igreja",         ("Organizações Religiosas",            "Setor Público e Associações")),
    ("templo",         ("Organizações Religiosas",            "Setor Público e Associações")),
    # Indústria e Produção
    ("confec",         ("Confecção e Têxtil",                 "Indústria e Produção")),
    ("vestuari",       ("Confecção e Têxtil",                 "Indústria e Produção")),
    ("moveis",         ("Móveis e Madeireiro",                "Indústria e Produção")),
    ("serralh",        ("Metalurgia e Serralheria",           "Indústria e Produção")),
    ("metalurg",       ("Metalurgia e Serralheria",           "Indústria e Produção")),
    ("grafica",        ("Impressão e Gráfica",                "Indústria e Produção")),
    ("impressor",      ("Impressão e Gráfica",                "Indústria e Produção")),
